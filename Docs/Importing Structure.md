...
**Main Flow**
1. Build-time import is declared in [Content.mgcb](C:/Dev/GitHub/obsidian/Engine/Content/Content.mgcb:16).
2. The project includes that content file through [Engine.csproj](C:/Dev/GitHub/obsidian/Engine/Engine.csproj:20).
3. Runtime content root is set to `Content` in [Engine.cs](C:/Dev/GitHub/obsidian/Engine/Engine.cs:37).
4. `ScreenManager` wires everything up and calls `Assets.Load(...)` in [ScreenManager.cs](C:/Dev/GitHub/obsidian/Engine/Logic/ScreenManager.cs:83).
5. Most game assets are loaded explicitly in [Assets.cs](C:/Dev/GitHub/obsidian/Engine/Recources/Assets.cs:94).
...
- [Engine/Engine.csproj](C:/Dev/GitHub/obsidian/Engine/Engine.csproj:20)  
...
- [Engine/Recources/ModelDefinition.cs](C:/Dev/GitHub/obsidian/Engine/Recources/ModelDefinition.cs:22)  
  Wraps a loaded `Model`. It also loads or creates:
  - `.bbox` bounding box sidecar files
  - `.sdft` signed distance field sidecar files

- [Engine/Recources/MaterialEffect.cs](C:/Dev/GitHub/obsidian/Engine/Recources/MaterialEffect.cs:11)  
...
- [Engine/Renderer/RenderModules/GBufferRenderModule.cs](C:/Dev/GitHub/obsidian/Engine/Renderer/RenderModules/GBufferRenderModule.cs:143)  
...
- [Engine/Recources/ShaderManager.cs](C:/Dev/GitHub/obsidian/Engine/Recources/ShaderManager.cs:18)  
